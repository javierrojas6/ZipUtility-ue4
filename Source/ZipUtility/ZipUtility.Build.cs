...
public class ZipUtility : ModuleRules
{
  ...
  private string VsDirectory
  {
    get
    {
      ...
      // change to current installed VS version
  ...
  private string ATLPath
  {
    get
    {
      ...
      {
        Console.WriteLine("ZipUtility Error: Couldn't find ATL/MFC Path module, maybe is not installed or fix it in ZipUtility.Build.cs");
      }
      return atlPath;
    }
  }
